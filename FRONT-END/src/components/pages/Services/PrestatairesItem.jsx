...
export default function PrestatairesItem({p}) {
    console.log(p);
  ...
  return (
    <div className={styles.PrestatairesItem}> 
        ...
        <p className={styles.location}>{p.location.city}, {p.location.region} ({p.location.postalCode})</p>
        <div className='d-flex'>
            <Link to={`/services/${p.id}`}className='mj-btn-primary'>Voir le profil</Link>
        </div>
        </div>
